            ...
            <main className="main">
                ...
                <section id="skills" className="skills section">
                    ...
                    <div className="our-story container" >
                        ...
                        <ul>
                            <li><i className="bi bi-check-circle"></i> <span>As one of the fastest-growing talent acquisition platforms, we are the preferred recruiting partner for numerous Fortune 500 companies.</span></li>
                            <li><i className="bi bi-check-circle"></i> <span>We specialize in helping clients identify and acquire the right talent, perfectly matching skills with business needs.</span></li>
                            <li><i className="bi bi-check-circle"></i> <span>Our platform provides access to multiple job opportunities tailored to industry-specific skills, ensuring the best fit for both candidates and companies.</span></li>
                            <li><i className="bi bi-check-circle"></i> <span>We are committed to delivering quality service with a high selection ratio and minimal turnaround time, ensuring efficiency and results in your recruitment process.</span></li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><i className="bi bi-check-circle"></i> <span>Serving clients from a wide array of industries, we’ve unlocked the secret to explosive growth for brands by crafting customized strategies that deliver real results. Whether it’s boosting visibility or driving traffic, our methods are proven to bring brands to the forefront of the digital landscape.</span></li>
                        ...
                        <h5 className="fw-bold mb-3">Innovative Lead Generation Strategies</h5>
                        ...
                        <h5 className="fw-bold mb-3">Top-Tier BPO Services</h5>
                       ...
                       {/*  <p>1. We are a leading BPO service provider specializing in engaging conversations across multiple platforms, helping businesses thrive in today’s competitive landscape.</p>
                        ...
                        <ul>
                            <li><i className="bi bi-check-circle"></i> <span>We are a leading BPO service provider specializing in engaging conversations across multiple platforms, helping businesses thrive in today’s competitive landscape.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>We recognize that your customers are the backbone of your business. That’s why we prioritize exceptional customer interactions.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>Our team boasts years of experience working with industry giants, excelling in customer service, solutions, and satisfaction.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>We pride ourselves on achieving a higher first call resolution rate, ensuring that customer issues are addressed promptly.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>Our advanced dashboard monitoring allows for real-time tracking of performance metrics to enhance service delivery.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>We offer digital recordings and playbacks, ensuring quality assurance and continuous improvement in our services.</span></li>

                            <li><i className="bi bi-check-circle"></i> <span>At GK Elite-Info, we are committed to uncompromised excellence in every aspect of our BPO services.</span></li>
                        ...
                        <div>
                                ...
                                <div className="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                                    <div className="team-member">
                                        <div className="member-img">
                                            <img src="/assets/img/team/team-2.png" className="img-fluid" alt="Narra Shiva Prasad" title="Narra Shiva Prasad" />
                            ...
                            <div className="row gy-4" style={{ display: "flex", justifyContent: "center" }}>
                                ...
                                <div className="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                                    <div className="team-member">
                                        <div className="member-img">
                                            <img src="/assets/img/team/team-4.png" className="img-fluid" alt="Lalit Adithya" title="Lalit Adithya" />
                                            <div className="social">
                                                <Link href=""><i className="bi bi-linkedin"></i></Link>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                                    <div className="team-member">
                                        <div className="member-img">
                                            <img src="/assets/img/team/team-1.png" className="img-fluid" alt="Shikar Baduria" title="Shikar Baduria" />
                                            <div className="social">
                                                <Link href=""><i className="bi bi-linkedin"></i></Link>
                                            </div>
                                        </div>
